...
<script>
    ...
    function renderTable(orders) {
        ...
        orders.forEach(order => {
            ...
            <td class="px-6 py-4 text-sm space-x-2">
                ...
                ${order.status === 'rascunho' ? `<button onclick="confirmOrder(${order.id})" class="text-purple-600 hover:text-purple-800">Confirmar</button>` : ''}
    ...
    function getStatusClass(status) {
        const classes = {
            ...
            'processamento': 'bg-yellow-100 text-yellow-800',
